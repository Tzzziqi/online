        ...
        http
                ...
                .authorizeHttpRequests(auth ->
                        auth
                                ...
                                .requestMatchers(HttpMethod.POST, "/order/*", "/cart", "/checkout").authenticated()
                                .requestMatchers(HttpMethod.GET, "/order/*", "/cart", "/checkout").authenticated()
                ...
                .and()
                .formLogin()
                .failureForwardUrl("/login?error=true")// Why do we need this??
